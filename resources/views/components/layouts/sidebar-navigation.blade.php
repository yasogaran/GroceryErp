<nav class="px-2 py-4 space-y-1">
    @php
        // Define menu groups with separators for better organization
        $menuGroups = [
            // Group 1: Daily Operations (Most Frequent)
            'daily_operations' => [
    ...
    @foreach ($menuGroups as $groupKey => $group)
        ...
        @if($hasAccess)
                ...
                @if (auth()->check() && in_array(auth()->user()->role, $item['roles']))
                    ...
                    <div class="relative group">
                        <a
                            ...
                            :class="sidebarCollapsed ? 'px-3 py-2.5 justify-center' : 'px-4 py-2.5'"
            ...
            @if(!$loop->last)
                <div x-show="!sidebarCollapsed" class="my-3 mx-3">
                    <div class="border-t border-gray-700"></div>
                </div>
                <div x-show="sidebarCollapsed" class="my-2">
                    <div class="border-t border-gray-700 mx-2"></div>
                </div>
            @endif
        @endif
    @endforeach
